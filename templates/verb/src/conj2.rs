...
impl Conjugation {
  pub fn gen_indicative2(&self, voice: Voice, tantum: Tantum, person: Person, time: Time) -> String {
    let gen_infect_end = |voice: Voice, tantum: Tantum, person: Person, time: Time| -> Vec<&'static str> {
      match (voice, tantum, person, time) {
        (Voice::Active, Tantum::Singular, Person::First, Time::Present)     => vec!["eō"],
  ...
  pub fn gen_subjunctive2(&self, voice: Voice, tantum: Tantum, person: Person, time: Time) -> String {
    let gen_infect_end = |voice: Voice, tantum: Tantum, person: Person, time: Time| -> Vec<&'static str> {
      match (voice, tantum, person, time) {
  ...
  pub fn gen_imperative2(&self, voice: Voice, tantum: Tantum, person: Person, time: Time) -> String {
    let gen_end = |voice: Voice, tantum: Tantum, person: Person, time: Time| -> Vec<&'static str> {
      match (voice, tantum, person, time) {
        (Voice::Active, Tantum::Singular, Person::Second, Time::Present)  => vec!["ē"],
        (Voice::Active, Tantum::Singular, Person::Second, Time::Future)   => vec!["ēto"],
        (Voice::Passive, Tantum::Singular, Person::Second, Time::Present) => vec!["āre"],
        (Voice::Passive, Tantum::Singular, Person::Second, Time::Future)  => vec!["ētor"],
        (Voice::Active, Tantum::Singular, Person::Third, Time::Future)    => vec!["ētō"],
        (Voice::Passive, Tantum::Singular, Person::Third, Time::Future)   => vec!["ētor"],
        (Voice::Active, Tantum::Plural, Person::Second, Time::Present)    => vec!["ēte"],
        (Voice::Active, Tantum::Plural, Person::Second, Time::Future)     => vec!["ētōte"],
        (Voice::Passive, Tantum::Plural, Person::Second, Time::Present)   => vec!["ēminī"],
        (Voice::Active, Tantum::Plural, Person::Third, Time::Future)      => vec!["entō"],
        (Voice::Passive, Tantum::Plural, Person::Third, Time::Future)     => vec!["entor"],
        _ => unreachable!(),
      }
    };
    let stem = self.infect_stem.as_slice();
  ...
  pub fn gen_infinitive2(&self, voice: Voice, tantum: Tantum, person: Person, time: Time) -> String {
    ...
    let end = match (voice, time) {
      (Voice::Active, Time::Present)  => vec!["ēre"],
      (Voice::Active, Time::Perfect)  => vec![""],
      (Voice::Active, Time::Future)   => vec!["um esse"],
      (Voice::Passive, Time::Present) => vec!["ērī"],
  ...
  pub fn gen_participle2(&self, voice: Voice, tantum: Tantum, person: Person, time: Time) -> String {
    let stem = match (voice, time) {
      (Voice::Active, Time::Present)  => &self.infect_stem,
      (Voice::Active, Time::Future)   => &self.supine_stem,
      (Voice::Passive, Time::Perfect) => &self.supine_stem,
  ...
  pub fn gen_noun2(&self, noun: VerbalNoun) -> String {
    let stem = match noun {
