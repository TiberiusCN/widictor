...
impl Conjugation {
  pub fn gen_indicative1(&self, voice: Voice, tantum: Tantum, person: Person, time: Time) -> String {
  ...
  pub fn gen_subjunctive1(&self, voice: Voice, tantum: Tantum, person: Person, time: Time) -> String {
    let gen_infect_end = |voice: Voice, tantum: Tantum, person: Person, time: Time| -> Vec<&'static str> {
      match (voice, tantum, person, time) {
  ...
  pub fn gen_imperative1(&self, voice: Voice, tantum: Tantum, person: Person, time: Time) -> String {
  ...
  pub fn gen_infinitive1(&self, voice: Voice, tantum: Tantum, person: Person, time: Time) -> String {
  ...
  pub fn gen_participle1(&self, voice: Voice, tantum: Tantum, person: Person, time: Time) -> String {
    let stem = match (voice, time) {
      (Voice::Active, Time::Present)  => &self.infect_stem,
      (Voice::Active, Time::Future)   => &self.supine_stem,
      (Voice::Passive, Time::Perfect) => &self.supine_stem,
  ...
  pub fn gen_noun1(&self, noun: VerbalNoun) -> String {
    let stem = match noun {
